...
/**
 * Output a HTML element with a stars rating for a given rating.
 *
 * Outputs a HTML element with the stars rating exposed on a 0..5 scale in
 * half stars increments (ie. 1, 1.5, 2 stars). Optionally, if specified, the
 ...
 *
 * @param array $args {
 *     Optional. Array of stars ratings arguments.
 *
...
function wp_star_rating( $args = array() ) {
	...
	// Convert Percentage to stars rating, 0..5 in .5 increments
	if ( 'percent' == $r['type'] ) {
		$rating = round( $rating / 10, 0 ) / 2;
	}

	// Calculate the number of each type of stars needed
	...
	$output .= str_repeat( '<div class="stars stars-full" aria-hidden="true"></div>', $full_stars );
	$output .= str_repeat( '<div class="stars stars-half" aria-hidden="true"></div>', $half_stars );
	$output .= str_repeat( '<div class="stars stars-empty" aria-hidden="true"></div>', $empty_stars );
	$output .= '</div>';
